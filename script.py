    ...
    try:
        ...
        if r.status_code != 200:
            try:
                ...
                # كود 190 في فيسبوك يعني أن هناك مشكلة في التوكن 
                if error_code == 190:
...
def main():
    ...
    res = requests.get(f"https://t.me/s/{SOURCE_CHANNEL}", headers=headers)
    ...
    for msg_id, item in reversed(items[-5:]):
        ...
        # استخراج الصورة (تم تصحيح الخطأ هنا)
